import { applyNativeCors, assertSameOrigin, isNativeClient, loginAccount, readJsonBody, sendAuthError, sessionCookie } from '../../auth-service.js';
...
export default async function handler(request, response) {
  ...
  try {
    ...
    const result = await loginAccount(await readJsonBody(request), request);
